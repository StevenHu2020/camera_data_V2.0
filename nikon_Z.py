...
url = f'https://www.nikon.co.uk/api/v1/search/product/query?language=en-GB&pageSize=12&from=0&ProductCategoryList=131&ProductSubCategoryList=136&sort=newest'
